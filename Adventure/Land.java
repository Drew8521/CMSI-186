public class Land {
    ...
    public Land(String name, String vessel, int companions) {
        this.name = name;
        this.vessel = vessel;
    ...
    public void getLocationStatus() {
        System.out.println("We are now travelling in " + this.name + " in a " + this.vessel + " with " + this.companions + " people!");
    }
