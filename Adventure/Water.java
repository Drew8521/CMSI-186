public class Water {
    ...
    public Water(String name, String vessel, int companions) {
        this.name = name;
        this.vessel = vessel;
    ...
    public void getLocationStatus() {
        System.out.println("We are now sailing on the " + this.name + " in a " + this.vessel + " with " + this.companions + " people!");
    }
